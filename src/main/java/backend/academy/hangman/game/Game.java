...
public class Game {
    ...
    public void start() {
        ...
        userInterface.showListMessage(Constants.WORD_CATEGORIES);
        ...
        while (remainingAttempts > 0 && finderWord.indexOf("_") != -1) {
            ...
            userInterface.showMessage(
                    Constants.HANGMAN_STAGES[Constants.MAX_ATTEMPTS - remainingAttempts]);
        ...
        userInterface.showMessage(
                (remainingAttempts <= 0) ? Constants.MESSAGE_LOSS : Constants.MESSAGE_WIN);
    }
